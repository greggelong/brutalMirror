...
function preload() {
  ...
  gs[6] = loadImage("gs/p1.jpg");
  gs[5] = loadImage("gs/p1.jpg");
  gs[4] = loadImage("gs/p0.jpg");
  gs[3] = loadImage("gs/p2.jpg");
  gs[2] = loadImage("gs/p3.jpg");
  gs[1] = loadImage("gs/p3.jpg");
  gs[0] = loadImage("gs/p3.jpg");
}
function setup() {
